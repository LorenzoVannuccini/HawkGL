...
this.__appendShadingHeader("#define DT_USE_LOGARITMIC_DEPTH (0)                                                                                                                                                       \n" +
                           "                                                                                                                                                                                          \n" +
                           "lowp int DT_getSliceID(in highp float z, const highp vec2 depthRange)                                                                                                                     \n" +
                           "{                                                                                                                                                                                         \n" +
                           "    z = (z - depthRange.x) / (depthRange.y - depthRange.x);                                                                                                                               \n" +
                           "                                                                                                                                                                                          \n" +
                           "#if DT_USE_LOGARITMIC_DEPTH                                                                                                                                                               \n" +
                           "    z = sqrt(z);                                                                                                                                                                          \n" +
                           "#endif                                                                                                                                                                                    \n" +
                           "                                                                                                                                                                                          \n" +
                           "    return clamp(int(z * 10.0), 0, 9);                                                                                                                                                    \n" +
                           "}                                                                                                                                                                                         \n" +
                           "                                                                                                                                                                                          \n" +
                           ...
                           "                                                                                                                                                                                          \n" +
                           "    hit.lod = (profile.hintTraceFromWithin ? 0 : maxLod); // start search from ground-truth if ray shoots from within                                                                     \n" +
                           "                                                          // otherwise search from 1x1 LOD (faster convergence)                                                                           \n" +
                           "                                                                                                                                                                                          \n" +
                           ...
                           "        hit.lod = maxLod;                            // start search from 1x1 LOD (faster convergence)                                                                                    \n" +
                           "    }                                                                                                                                                                                     \n" +
                           "    // ray is inside, begin search                                                                                                                                                        \n" +
                           "                                                                                                                                                                                          \n" +
                           "    bool intersects = false; // intersection outcome                                                                                                                                      \n" +
                           ...
                           "        if((hitsDistance.y <= 0.0)) // misses ? -> march and un-subdivide                                                                                                                 \n" +
                           "        {                                                                                                                                                                                 \n" +
